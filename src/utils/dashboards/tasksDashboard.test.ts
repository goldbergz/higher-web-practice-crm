...
describe("getLastTasks", () => {
  const tasks: Task[] = [
    { id: "t1", title: "Old task", assigneeId: "u1", status: "completed", createdAt: "2024-01-01T10:00:00Z", createdBy: "u1" },
    { id: "t2", title: "Recent task", assigneeId: "u1", status: "new", createdAt: "2024-06-01T10:00:00Z", createdBy: "u1" },
    { id: "t3", title: "Middle task", assigneeId: "u1", status: "in_progress", createdAt: "2024-03-01T10:00:00Z", createdBy: "u1" },
  ];
